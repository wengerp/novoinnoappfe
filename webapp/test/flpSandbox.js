		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NOVO Innovation Day App",
									"targetURL": "#chnovobcnovoinnoapfe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chnovobcnovoinnoapfe-display": {
								"semanticObject": "chnovobcnovoinnoapfe",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ch.novobc.novoinnoapfe",
									"url": sap.ui.require.toUrl("ch/novobc/novoinnoapfe")
								}
							}
						}
					}
